          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-100 p-3 rounded-lg shadow-sm">
              <span className="text-gray-700">
                Tengo conocimiento de que la presente Declaración Jurada y documentación está sujeta a fiscalización posterior. En caso de haber proporcionado información falsa, se aplicarán sanciones y la revocatoria de la licencia otorgada.
              </span>
            </div>
          </div>

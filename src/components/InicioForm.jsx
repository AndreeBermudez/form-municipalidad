      ...
      <div className="p-6 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          <form onSubmit={handleSubmit} className="border rounded-lg p-5 shadow-md bg-white">
            ...
            <div className="mb-4">
              <label htmlFor="paymentCode" className="block text-sm font-medium text-gray-700">CÓDIGO DE PAGO</label>
              <input
                type="text"
                id="paymentCode"
                name="paymentCode"
            ...
            <button
              type="button"
              className="text-blue-500 text-sm hover:underline mt-3 w-full text-center"
            >

...
const FormPageOne = () => {
  ...
  // Se extrae el tipo de persona del state; se asume "juridica" por defecto.
  const personType = location.state?.personType || 'juridica';

  // Se definen los pasos condicionalmente
  ...
  const currentStep = 1; // Primera página
  ...
  const handleNext = () => {
    navigate('/formulario/pag-solicitante', { state: { personType } });
  };

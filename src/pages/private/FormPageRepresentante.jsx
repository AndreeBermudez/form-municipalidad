...
const FormPageRepresentante = () => {
  ...
  // Si el usuario es persona natural, redirige al siguiente paso sin mostrar este formulario
  useEffect(() => {
  ...
  // Definir los pasos según el tipo de persona
  ...
  const currentStep = 3; // Aplica si es jurídica

  const handleBack = () => navigate('/formulario/pag-inder', { state: { personType } });
  const handleNext = () => navigate('/formulario/pag-establecimiento', { state: { personType } });
          ...
          <Grid item xs={12} md={7}>
            <Paper sx={styles.paper}>
              ...
              <Box sx={styles.navigationContainer}>
                ...
                {/* MobileStepper solo en dispositivos móviles */}
